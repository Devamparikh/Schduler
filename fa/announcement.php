...
<head>
  ...
  <title>Scheduler | Compose Announcement Message</title>
...
?>
  ...
  <div class="content-wrapper">
      <form action='announcement_db_connection.php?login=<?php echo $professor_id; ?>' method='post'>
          ...
          <div class="col-md-14">
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">Compose New Announcement Message</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <div class="form-group">
                    <textarea id="compose-textarea" class="form-control" style="height: 300px" name="announcement">
                      <h4><u>Announcement: Heading</u></h4>
                      <p>Please enter the announcement here that you want to make. The text editor provided has many different functionalities which will help you make better announcements.</p>
                      <ul>
                  ...
                  <label for="ending_time" class="btn btn-flat" style="align-items: right">Ending Time : </label>
                    <input type="date" name="ending_time">
