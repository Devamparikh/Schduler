...
<head>
  ...
  <title>Scheduler | Subject Data Base-AP </title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Subjects Data Entry</h1>
          </div>
                <!-- Main content -->
    ...
    if(isset($_POST['subject'])){
      ...
      $subject_short = $_POST['name_short'];
      $subject_code = $_POST['code'];
      $subject_dept = $_POST['dept'];
      $subject_sem = $_POST['sem'];
      $query = "INSERT INTO `subject` (`subject_id`, `subject_name`, `subject_sem`, `subject_dept_id`, `subject_code`, `subject_short`) VALUES (NULL, '$subject_name', '$subject_sem', '1', '$subject_code', '$subject_short')";
                ...
                <div class='col-md-6'>
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">To Add Subjects Data</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                            <form role="form" action="" method = "post">
                              <div class="card-body" width="200" height="200">
                                ...
                                <div class="form-group">
                                  <label for="exampleInputnumbeer">Subject Code</label>
                                  <input type="subjectcode" class="form-control" id="number" name="code" placeholder="Enter Subject Code">
                                </div>
                                <div class="form-group">
